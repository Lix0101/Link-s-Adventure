...
class Player(Entity):
    def __init__(self, pos, groups, obstacle_sprites, create_attack, destroy_attack, create_magic,):
        ...
        self.image = pygame.image.load('../src/src_imgs/test/player.png').convert_alpha()
        self.rect = self.image.get_rect(topleft=pos)
        self.hitbox = self.rect.inflate(-6, HIT_OFFSET['player'])
    ...
    def import_player_assets(self):
        character_path = '../src/src_imgs/player/'
        self.animations = {
            'up': [], 'down': [], 'left': [], 'right': [],
    ...
    def heal_player_energy(self, amount):
        self.energy += amount
